...
def train_argparser():
    ...
    parser.add_argument('--timeout', type=int, default=3600, help='Timeout in seconds for hyperparameter tuning')
    ...
    parser.add_argument(
        "--attention_heads", default=1, type=int, help="number of multi-attention heads"
    )
