...
def train_argparser():
    ...
    # Enhanced GCN parameters (from best trial)
    parser.add_argument("--use_improved_gcn", default=True, help="Use improved GCN modules")
    parser.add_argument("--gcn_type", default="hybrid", help="Type of GCN to use")
    parser.add_argument("--use_residual", default=True, help="Use residual connections")
    parser.add_argument("--use_layer_norm", default=True, help="Use layer normalization")
    parser.add_argument("--use_multi_scale", default=True, help="Use multi-scale features")
    parser.add_argument("--use_graph_attention", default=True, help="Use graph attention")
    ...
    parser.add_argument(
        "--lstm_dim", type=int, default=384, help="dimension of lstm cell"
    )
    parser.add_argument(
        "--prefix", type=str, default="data/", help="dataset and embedding path prefix"
    )
    parser.add_argument(
        "--span_generator",
        type=str,
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="If False, training not case sentive",
    )
    parser.add_argument(
        "--max_pairs",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="There is a maximum number of samples in queue",
    )
    parser.add_argument(
        "--neg_entity_count",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=25,
        help="Dimensionality of size embedding,E_{k}",
    )
    parser.add_argument(
        "--sampling_processes",
        type=int,
    ...
    parser.add_argument("--lr", type=float, default=1.71e-6, help="Learning rate")
    parser.add_argument(
        "--lr_warmup",
        type=float,
        default=0.15,
    ...
    parser.add_argument(
        ...
        type=str,
        default="log/",
        help="Path do directory where training/evaluation logs are stored",
    )
    parser.add_argument(
        "--train_log_iter",
        type=int,
