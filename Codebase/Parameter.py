...
def train_argparser():
    ...
    parser.add_argument('--hidden_dim', type=int, default=768, help='Hidden layer dimension')  # Updated for DeBERTa V2
    ...
    parser.add_argument('--tokenizer_path', default='microsoft/deberta-v2-large', type=str, help="Path to tokenizer")
    parser.add_argument('--pretrained_bert_name', default='microsoft/deberta-v2-large', type=str, help="Pretrained model name")
