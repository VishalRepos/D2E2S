...
def train_argparser():
    ...
    parser.add_argument('--mem_dim', type=int, default=1024, help='mutual biaffine men dim.')  # Updated for DeBERTa v3
    ...
    parser.add_argument('--bert_feature_dim', type=int, default=1024, help='dimension of pretrained bert feature')  # Updated for DeBERTa v3
    ...
    # Update the tokenizer path and model name for DeBERTa v3
    parser.add_argument('--tokenizer_path', default='microsoft/deberta-v3-base', type=str, help="tokenizer load_path")
    ...
    parser.add_argument('--freeze_transformer', action='store_true', default=False, help="Freezing DeBERTa's parameters for easy test")
    ...
    parser.add_argument('--pretrained_bert_name', default='microsoft/deberta-v3-base', type=str)  # Updated for DeBERTa v3
